...
import { pf2eGetActorInventoryBody } from '../../src/evaluators/pf2e-get-actor-inventory.js';
...
describe('pf2eGetActorInventoryBody', () => {
  beforeEach(() => {
  ...
  it('returns ACTOR_NOT_FOUND for a missing actor id', async () => {
    ...
    const result = await pf2eGetActorInventoryBody({ actorId: 'doesNotExist' });
  ...
  it('filters non-physical types out of the inventory', async () => {
    ...
    const result = await pf2eGetActorInventoryBody({ actorId: 'valeros0000000000' });
