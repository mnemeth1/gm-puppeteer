{ ===========================================================================
  ...
  PacksEdit, HeadlessCheck, WarmCheck) are declared in the main script's
  global var block.
  =========================================================================== }
...
begin
  ...
  FoundryPage.Values[0] := 'http://localhost:30001';
  ...
  Lbl.Top := Y;
  Lbl.AutoSize := True;
  Lbl.Caption := 'Compendium packs to fully warm at startup, comma-separated ' +
    '(WARM_PHASE2_PACKS):';

  Y := Y + ScaleY(18);
  PacksEdit := TNewEdit.Create(BehaviorPage);
  PacksEdit.Parent := BehaviorPage.Surface;
  PacksEdit.Top := Y;
  PacksEdit.Width := BehaviorPage.SurfaceWidth;
  PacksEdit.Text := 'pf2e.pathfinder-monster-core';
...
begin
  ...
  Lines[9]  := 'WARM_PHASE2_PACKS=' + Trim(PacksEdit.Text);
