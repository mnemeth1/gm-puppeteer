 ...
 */
export interface Pf2eTransferItemBetweenActorsInput {
...
export type Pf2eTransferItemBetweenActorsOk =
  | {
      ok: true;
...
export interface Pf2eTransferItemBetweenActorsErr {
  ok: false;
  error: {
    code: 'INVALID_INPUT';
    message: string;
...
export type Pf2eTransferItemBetweenActorsResult =
  | Pf2eTransferItemBetweenActorsOk
  | Pf2eTransferItemBetweenActorsErr;
...
export async function pf2eTransferItemBetweenActorsBody(
  input: Pf2eTransferItemBetweenActorsInput,
): Promise<Pf2eTransferItemBetweenActorsResult> {
  ...
  if (mode === 'split') {
    ...
    if (
      ...
      const result: Pf2eTransferItemBetweenActorsOk = {
        ok: true,
