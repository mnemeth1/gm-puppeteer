 ...
 */
export interface Pf2eGetActorInventoryInput {
  actorId: string;
}
...
export interface Pf2eGetActorInventoryOk {
  ok: true;
  actorId: string;
  actorName: string;
  items: InventoryItem[];
...
export interface Pf2eGetActorInventoryErr {
  ok: false;
  error: {
...
export type Pf2eGetActorInventoryResult = Pf2eGetActorInventoryOk | Pf2eGetActorInventoryErr;
...
export async function pf2eGetActorInventoryBody(
  input: Pf2eGetActorInventoryInput,
): Promise<Pf2eGetActorInventoryResult> {
