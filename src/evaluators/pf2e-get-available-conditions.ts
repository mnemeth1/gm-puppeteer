...
export interface Pf2eGetAvailableConditionsOk {
  ok: true;
  conditions: ConditionSummary[];
}

export interface Pf2eGetAvailableConditionsErr {
  ok: false;
  error: {
    code: 'INVALID_INPUT';
    message: string;
...
export type Pf2eGetAvailableConditionsResult =
  | Pf2eGetAvailableConditionsOk
  | Pf2eGetAvailableConditionsErr;

export function pf2eGetAvailableConditionsBody(): Pf2eGetAvailableConditionsResult {
