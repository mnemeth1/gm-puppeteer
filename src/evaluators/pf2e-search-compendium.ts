 ...
 */
export interface Pf2eSearchCompendiumLevelFilter {
  min?: number | undefined;
  max?: number | undefined;
}

export interface Pf2eSearchCompendiumInput {
  query?: string | undefined;
  pack?: string | undefined;
  packs?: string[] | undefined;
  type?: string | undefined;
  level?: Pf2eSearchCompendiumLevelFilter | undefined;
...
export interface Pf2eSearchCompendiumResult {
  total: number;
  returned: number;
...
export async function pf2eSearchCompendiumBody(
  input: Pf2eSearchCompendiumInput,
): Promise<Pf2eSearchCompendiumResult> {
