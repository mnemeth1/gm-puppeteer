 ...
 */
export interface Pf2eGetCreatureDetailsInput {
  uuid: string;
...
export interface Pf2eGetCreatureDetailsOk {
  ok: true;
  uuid: string;
  id: string;
  name: string;
...
export interface Pf2eGetCreatureDetailsErr {
  ok: false;
  error: {
...
export type Pf2eGetCreatureDetailsResult = Pf2eGetCreatureDetailsOk | Pf2eGetCreatureDetailsErr;
...
export async function pf2eGetCreatureDetailsBody(
  input: Pf2eGetCreatureDetailsInput,
): Promise<Pf2eGetCreatureDetailsResult> {
  ...
  const out: Pf2eGetCreatureDetailsOk = {
    ok: true,
