 ...
 */
export interface Pf2eGetActorStateInput {
  actorId: string;
...
export interface Pf2eGetActorStateOk {
  ok: true;
  actor: ActorIdentity;
  hp: HPBlock;
  ac: { value: number };
...
export interface Pf2eGetActorStateErr {
  ok: false;
  error: {
...
export type Pf2eGetActorStateResult = Pf2eGetActorStateOk | Pf2eGetActorStateErr;
...
export async function pf2eGetActorStateBody(
  input: Pf2eGetActorStateInput,
): Promise<Pf2eGetActorStateResult> {
