...
import { pf2eUseItemBody, type Pf2eUseItemResult } from '../evaluators/pf2e-use-item.js';
...
export const pf2eUseItemTool: ToolDefinition<typeof Pf2eUseItemInput> = {
  name: 'pf2e_use_item',
  description:
  ...
  async handler(input, ctx) {
    ...
    const result = (await page.evaluate(pf2eUseItemBody, args)) as Pf2eUseItemResult;
    if (!result.ok) {
