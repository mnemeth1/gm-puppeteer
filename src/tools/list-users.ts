...
export const listUsersTool: ToolDefinition<typeof ListUsersInput> = {
  ...
  description:
    ...
    'isGM (true for ASSISTANT/GAMEMASTER), and active (currently logged in). Sorted by ' +
    'name. Use this to discover the userId you need to pass into assign_actor_ownership ' +
    ...
    'output and is identifiable as a GM with active=true.',
