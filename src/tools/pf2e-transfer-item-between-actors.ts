...
import {
  pf2eTransferItemBetweenActorsBody,
  type Pf2eTransferItemBetweenActorsResult,
} from '../evaluators/pf2e-transfer-item-between-actors.js';
 ...
 */
const Pf2eTransferItemBetweenActorsInput = z
  .object({
    sourceActorId: z
      .string()
      .min(1)
...
export const pf2eTransferItemBetweenActorsTool: ToolDefinition<
  typeof Pf2eTransferItemBetweenActorsInput
> = {
  ...
  inputSchema: Pf2eTransferItemBetweenActorsInput,
  async handler(input, ctx) {
    ...
    const result = (await page.evaluate(
      pf2eTransferItemBetweenActorsBody,
      args,
    )) as Pf2eTransferItemBetweenActorsResult;
    if (!result.ok) {
