...
export const listWorldActorsTool: ToolDefinition<typeof ListWorldActorsInput> = {
  ...
  description:
    ...
    'directory. One row per actor with id, uuid, name, type, level, and folderId, ' +
    'sorted by name. Use this to discover the actorId you need to pass into ' +
    'get_actor_state, get_actor_inventory, get_creature_details, or any actor- ' +
    'mutation tool. NOT for compendium actors — use search_compendium for those. ' +
  ...
  async handler(_input, ctx) {
    ...
    return [jsonText({ actors: result.actors })];
  },
};
