...
export const listWorldActorsTool: ToolDefinition<typeof ListWorldActorsInput> = {
  ...
  description:
    ...
    'pass into pf2e_get_actor_state, pf2e_get_actor_inventory, pf2e_get_creature_details, or any ' +
    ...
    'active). NOT for compendium actors — use pf2e_search_compendium for those. ' +
    'NOT a stat-block view — use pf2e_get_actor_state (PCs / NPCs / familiars by id) ' +
    'or pf2e_get_creature_details (NPCs / hazards / familiars by uuid) for combat- ' +
