...
import {
  pf2eRemoveConditionBody,
  type Pf2eRemoveConditionResult,
} from '../evaluators/pf2e-remove-condition.js';
 ...
 * suppress.
 */
const Pf2eRemoveConditionInput = z
  .object({
    actorId: z
      .string()
      .min(1)
...
export const pf2eRemoveConditionTool: ToolDefinition<typeof Pf2eRemoveConditionInput> = {
  ...
  inputSchema: Pf2eRemoveConditionInput,
