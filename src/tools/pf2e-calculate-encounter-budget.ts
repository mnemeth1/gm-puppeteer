...
const Pf2eCalculateEncounterBudgetInput = z
  .object({
    partyLevel: z
      .number()
      .int()
...
export interface Pf2eCalculateEncounterBudgetResult {
  partyLevel: number;
  partySize: number;
...
function computeBudget(
  input: z.infer<typeof Pf2eCalculateEncounterBudgetInput>,
): Pf2eCalculateEncounterBudgetResult {
...
export const pf2eCalculateEncounterBudgetTool: ToolDefinition<
  typeof Pf2eCalculateEncounterBudgetInput
> = {
  ...
  inputSchema: Pf2eCalculateEncounterBudgetInput,
