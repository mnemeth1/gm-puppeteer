...
type SearchCompendiumArgs = z.infer<typeof SearchCompendiumInput>;

function hasAnyFilter(input: SearchCompendiumArgs): boolean {
  return (
...
export const searchCompendiumTool: ToolDefinition<typeof SearchCompendiumInput> = {
  ...
  async handler(input, ctx) {
    ...
    const result = (await page.evaluate(searchCompendiumBody, args)) as SearchCompendiumResult;
